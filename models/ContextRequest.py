...
class ContextRequest(BaseModel):
    ...
    context_files: List[ContextFile] = Field(default=[ContextFile(name="improved_case.md", content="""
...
## Enkele concepten in detail:
    ...
    Leverafspraak: altijd tussen 8.00 en 20.00 uur, maximaal 40 afspraken per uur. U heeft een aankomstvenster van 1 uur. Als u uw tijdslot mist, moet u na 20.00 uur in de rij staan om binnen te komen. Wij werken het hele jaar door 24/7. De laatste afspraak kan om 19.00 uur, en die vrachtwagen mag binnen tot 19.59 uur. Afspraken worden gemaakt per slot, niet op een specifiek uur, dus bv. voor het slot 10.00u tot 11.00. Dit systeem zorgt voor een georganiseerde en efficiënte afhandeling van vrachtwagens, met minimale wachttijden en maximale doorvoer.
        Tussen 20.00 en 8.00 uur kun je in de rij staan, maar omdat KdG in nachtregime werkt, kunnen er slechts 10 vrachtwagens per uur binnenkomen. De wachtrij zonder afspraak is FIFO. Dit nachtregime zorgt voor een continue operatie, zij het met een lagere capaciteit.
...
ContextFile(name="MoreInfo.md", content="""
# Meer informatie

## Achtergrond

KdG is een toonaangevend bedrijf in de logistieke sector, gespecialiseerd in de opslag en verwerking van mineralen en grondstoffen. Het bedrijf opereert vanuit een strategisch gelegen haven, waar het een uitgebreid netwerk van magazijnen en faciliteiten beheert. KdG staat bekend om zijn efficiënte logistieke processen, geavanceerde technologie en klantgerichte aanpak.

## Uitdaging

KdG staat voor de uitdaging om zijn logistieke processen verder te optimaliseren en te stroomlijnen. Het bedrijf wil de efficiëntie van zijn magazijnbeheer, vrachtwagenverwerking en scheepslogistiek verbeteren. Daarnaast wil KdG zijn financiële processen automatiseren en de klanttevredenheid verhogen door transparante en nauwkeurige facturering.

## Doelstellingen

De belangrijkste doelstellingen van KdG zijn:

    Verbetering van de operationele efficiëntie en doorvoer van goederen.
    Verlaging van logistieke kosten en wachttijden.
    Optimalisatie van voorraadbeheer en magazijnprocessen.
    Automatisering van financiële processen en facturering.
    Verhoging van de klanttevredenheid door betere service en transparantie.
""")])